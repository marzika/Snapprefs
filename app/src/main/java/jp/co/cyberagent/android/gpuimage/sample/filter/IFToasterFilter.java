...
public class IFToasterFilter extends IFImageFilter {
    ...
    public IFToasterFilter() {
        super(SHADER);
        setRes();
    }

    private void setRes() {
        addInputTexture("toaster_metal");
        addInputTexture("toaster_soft_light");
        addInputTexture("toaster_curves");
        addInputTexture("toaster_overlay_map_warm");
        addInputTexture("toaster_color_shift");
    }
}
