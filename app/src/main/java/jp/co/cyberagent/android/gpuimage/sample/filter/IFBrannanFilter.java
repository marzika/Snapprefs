...
public class IFBrannanFilter extends IFImageFilter {
    ...
    public IFBrannanFilter() {
        super(SHADER);
        setRes();
    }

    private void setRes() {
        addInputTexture("brannan_process");
        addInputTexture("brannan_blowout");
        addInputTexture("brannan_contrast");
        addInputTexture("brannan_luma");
        addInputTexture("brannan_screen");
    }
}
