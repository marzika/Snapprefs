...
public class IFEarlybirdFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture("earlybird_curves");
        addInputTexture("earlybird_overlay_map");
        addInputTexture("vignette_map");
        addInputTexture("earlybird_blowout");
        addInputTexture("earlybird_map");
    }
}
