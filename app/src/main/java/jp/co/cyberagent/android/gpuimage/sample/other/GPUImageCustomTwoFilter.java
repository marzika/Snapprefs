...
public class GPUImageCustomTwoFilter extends GPUImageFourTextureFilter {
    ...
    public GPUImageCustomTwoFilter() {
        super(SHADER);
        setRes();
    }
    ...
    private void setRes() {
        ...
        arrayOfBitmap[0] = BitmapFactory.decodeFile(PathUtil.getPath("toaster_soft_light"));
        arrayOfBitmap[1] = BitmapFactory.decodeFile(PathUtil.getPath("toaster_curves"));
        arrayOfBitmap[2] = BitmapFactory.decodeFile(PathUtil.getPath("toaster_overlay_map_warm"));
        arrayOfBitmap[3] = BitmapFactory.decodeFile(PathUtil.getPath("toaster_color_shift"));
