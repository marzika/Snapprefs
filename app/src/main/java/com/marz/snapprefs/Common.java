...
public final class Common {
    ...
    final static String Class_Screenshot1 = basename + ".model.ReceivedSnap";
    final static String Class_Screenshot2 = "aig";
    final static String Class_Screenshot3 = basename + ".model.ReceivedSnap";
    final static String Class_CaptionView = basename + ".ui.VanillaCaptionView";
    final static String Class_Friend = "ahk";
    ...
    final static String Class_PostToStory = "ajy";
    final static String Class_SnapPreviewFragment = basename + ".SnapPreviewFragment";
    final static String Method_Screenshot2 = "an";
    final static String Method_Screenshot3 = "d";
    final static String Method_AfterTextChanged = "afterTextChanged";
    final static String Method_BestFriend = "l"; //w or v
    ...
    final static String Method_AddToList = "i";
    final static String Method_CreateView = "k"; // prev. i, h
    final static String Method_Invisible = "j"; //prev. t, q, p
    final static String Method_Visible = "r"; //prev. q, o
    ...
    final static String sendToFriendSet = "l"; //prev. m, l
    final static String sendToStoryList = "m"; //prev. n, m
